...
while a != 1:
    if a != 0:
        ...
        print("Що не очікували? А я спробувала. Чуть не задимівся комп'ютер:)До роче 0 виняток з правил, бо 1 він ніколи не дасть.(Хоча 0^0=1;0!=1 Про факторіал сама не знала, гугл корисна річь)")
        break
if a == 1:
    print(f"\nТак усі числа при цьому в рузельтаті дадуть {int(a)}")
else:
