...
var = IntVar()
boxOn2 = Label(text='Виберіть знижку',bg='#FFFFFF', fg='#F0865E')
...
rbut3 = Radiobutton(text='Разом',variable=var,value=3,bg='#FFFFFF', fg='#F0865E')
boxOn3 = Label(text='Виберіть соус, 3 грн.',bg='#FFFFFF', fg='#F0865E')
var_2 = IntVar()
ch1 = Checkbutton(text='Майонез',bg='#FFFFFF', fg='#F0865E',variable=var_2)
var_3 = IntVar()
ch2 = Checkbutton(text='Кетчуп',bg='#FFFFFF', fg='#F0865E',variable=var_3)
var_4 = IntVar()
ch3 = Checkbutton(text='Соус',bg='#FFFFFF', fg='#F0865E',variable=var_4)
var_5 = IntVar()
ch4 = Checkbutton(text='Ананаси',bg='#FFFFFF', fg='#F0865E',variable=var_5)
...
rbut3.place(x=420, y=75)
boxOn3.place(x=570, y=10)
ch1.place(x=570, y=35)
ch2.place(x=570, y=55)
ch3.place(x=570, y=75)
ch4.place(x=570, y=95)
tk.mainloop()